...
{
<<<<<<<< HEAD:Movies4All.Data/Migrations/20230524104932_resetDatabase.cs
    public partial class resetDatabase : Migration
========
    public partial class NewMovies : Migration
>>>>>>>> 2110637edc3712ea67fe0a0fa6690070e1127443:Movies4All.Data/Migrations/20230520124429_NewMovies.cs
    {
...
========
                    ...
                    VirefieAT = table.Column<DateTime>(type: "datetime2", nullable: true),
...
>>>>>>>> 2110637edc3712ea67fe0a0fa6690070e1127443:Movies4All.Data/Migrations/20230520124429_NewMovies.cs
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Movies__Director__2D27B809",
                        column: x => x.DirectorID,
                        principalTable: "Directors",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Movies__GenreID__2C3393D0",
                        column: x => x.GenreID,
                        principalTable: "Genres",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Movies__RatingID__2E1BDC42",
                        column: x => x.RatingID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Cast__ActorID__31EC6D26",
                        column: x => x.ActorID,
                        principalTable: "Actors",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Cast__MovieID__30F848ED",
                        column: x => x.MovieID,
