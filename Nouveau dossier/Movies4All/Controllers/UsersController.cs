...
namespace Movies4All.App.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public IActionResult AdminEndPoint()
        {
            ...
            return Ok($"Hi you are an {currentUser.Role} your name is {currentUser.Username}");
        }
